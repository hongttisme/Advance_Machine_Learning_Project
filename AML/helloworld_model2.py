import os
import torch
from our_graph2_encode import encode_node_features, encode_edge_features, encode_global_node_features, static_edge_index, static_edge_map, base_graph_edges, index_to_move
...
def start_model(checkpoint_file_name="checkpoints/ffv2.pth"):
